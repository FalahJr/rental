    ...
    <div id="mobil" style="height: 50vh;">
        <div class="container">
           ...
           <form action="" class="row">
            ...
            <div class="col-6"></div> 
            <div class="form-group col-6">
            <label for="tanggal_mulai"><strong>Nama Peminjam</strong></label>
            <input type="text" class="form-control" id="nama_peminjam" name="nama_peminjam" placeholder="Masukkan Nama">
            </div>
            <div class="form-group w-50 col-6">
            <label for="tanggal_selesai"><strong>No. KTP</strong></label>
            <input type="text" class="form-control" id="no_ktp" name="no_ktp" value="3514301234567890">
            </div>
            <div class="form-group w-50 col-6">
            <label for="tanggal_mulai"><strong>Tanggal Mulai Rental</strong></label>
            <input type="datetime" class="form-control" id="tanggal_mulai" name="tanggal_mulai" value="2020-11-18 10:00">
            </div>
            <div class="form-group w-50 col-6">
            <label for="tanggal_selesai"><strong>Tanggal Pengembalian</strong></label>
            <input type="datetime" class="form-control" id="tanggal_selesai" name="tanggal_selesai" value="2020-11-19 10:00">
            </div>
            <div class="form-group w-50 col-6">
            <label for="tanggal_selesai"><strong>Jenis Mobil</strong></label>
            <input type="text" class="form-control" id="no_ktp" name="no_ktp" value="Daihatsu Terios">
            </div>
            <div class="form-group w-50 col-6">
            <label for="tanggal_selesai"><strong>Harga Sementara</strong></label>
            <input type="text" class="form-control" id="no_ktp" name="no_ktp" value="IDR 100.000">
            </div>
            <!-- <div class="form-group w-50 col-6">
            ...
            <div class="col-1 mt-3">
                <a class="btn btn-danger btn-md" href="list-mobil.php">Batal</a>
            </div>
            <div class="col-3 mt-3">
                <a class="btn btn-primary btn-md" href="confirmation.php">Checkout</a>
            </div>
            <div class="col-3"></div>
