 ...
 <center>
    ...
    <div id="mobil" style="height: 50vh;">
        <div class="container">
           <div class="row">
               <div class="col-4">
               <img src="../assets/img/car.jpg" class="img-fluid w-100 mt-4">
               </div>
               ...
               <table border="0" class="table table-striped"  style="font-size: 15px; color:black">
                        ...
                        <div class="float-right mt-2">
                            <a href="list-mobil.php" class="btn btn-danger">Kembali</a>
                            <a href="list-driver.php" class="btn btn-primary">Pilih</a>
                        </div>
               </div>
           </div>
        </div>
