            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-xl-3 card-list">
                    <a class="link" href="info-mobil.php" style="text-decoration: none;">
                        <div class="card">
                            <img class="img-responsive img-destination" alt="a" src="../assets/img/car.jpg" width="100%">
                            <div class="card-body text-left">
                                ...
                                <p style="font-size: 13px;margin-top: -10px">IDR 100.000 / Hari</p>
                                <a class="btn btn-sm btn-primary w-100" href="list-driver.php">Pilih</a>
                            </div>
                        </div>
                    </a>
                </div>
