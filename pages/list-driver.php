...
<nav class="navbar navbar-expand-md navbar-dark fixed-top" style="background-color: #2E86DE;">
 ...
 <center>
     <h3>Pilih Supir</h3>
     <hr style="border: 1px solid black; width: 6%;">
     <br>
 </center>
    <div id="mobil">
        <div class="container">
                    ...
                    <a class="link" href="info-driver.php" style="text-decoration: none;">
                        <div class="card">
                            ...
                            <div class="card-body text-left">
                                ...
                                <p style="font-size: 13px;margin-top: -10px">29 Tahun</p>
                                <a class="btn btn-sm btn-primary w-100" href="info-driver.php">Pilih</a>
                            </div>
                        </div>
                    </a>
                </div>
...
<footer class="page-footer font-small" style="background-color: #2E86DE; color: white;">
    ...
    <div class="container" style="padding-bottom: 40px;">
      <span class="">&reg; 2020 Alright Reserved by Esjibi Team</span>
